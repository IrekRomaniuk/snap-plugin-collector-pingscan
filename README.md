...
Create a task manifest file and put firewall api key and IP address  (example files in [examples] (https://github.com/IrekRomaniuk/snap-plugin-collector-pingscan/blob/master/examples/task.yml)):
```yaml
version: 1
schedule:
  type: "simple"
